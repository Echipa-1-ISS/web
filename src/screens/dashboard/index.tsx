    ...
    const dashboard = (
        <Content style={{padding: '0 50px'}}>
            ...
            <div className="site-layout-content"
                ...
                <Card hoverable title={"Eliberarea adeverinţelor de student"}
                      style={{width: 400, marginLeft: 100, height: 450}}>
                    <p>Pentru toţi studenţii Facultăţii de Matematică şi Informatică, începând cu data de 27 septembrie
                        2021 se vor elibera adeverinţe de student. Modalitatea de obţinere a adeverinţei de student este
                        următoarea: Studentul completează toate datele personale şi scopul solicitării eliberării
                        adeverinţei la formularul de la adresa: https://forms.gle/drqqY8FqjsJA2hh7A, după care
                        personalul secretarial va emite adeverinţa care se trimite scanată la adresa de email indicată
                        de student. În situaţia în care, un student are nevoie de mai multe adeverinţe, se va completa
                        formularul de mai multe ori. Dacă un student are nevoie de adeverinţa de student în original va
                        specifica acest aspect în formular şi o va putea ridica de la Secretariatul facultăţii în orice
                        zi lucrătoare în intervalul orar 9,00-12,00.</p>
                </Card>
            </div>
        </Content>
    )
    ...
    return (
        <div id="dashboard">
            <Layout>
                ...
                <Layout>
                    <Sider>
                        <Menu mode={"inline"} selectedKeys={[selectedMenuItem]} onClick={(e) =>
